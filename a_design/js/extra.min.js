(function()
{
    ...
    (this,function(n,r)
    {
        var i,o,l,s,f,u,a,c,h,d,p,y,v,w,g,m;i=n(r);c=t.call(r,"ontouchstart")>=0;s=
        {
            horizontal:{},
            vertical:{}
        };
        ...
        ();l=function()
        {
            function t(t,e,r)
            {
                ...
                this.id="waypoints"+v++;this.offset=null;
                this.options=r;
        ...
        n.fn[g]=function()
        {
            var t,r;r=arguments[0],t=2<=arguments.length?e.call(arguments,1):[];
        ...
        h=
        {
            ...
            _invoke:function(t)
            {
                var e;e=n.extend({},s.vertical,s.horizontal);
        ...
        n[m]=function()
        {
            var t,n;n=arguments[0],t=2<=arguments.length?e.call(arguments,1):[];
            if(h[n])
            {
